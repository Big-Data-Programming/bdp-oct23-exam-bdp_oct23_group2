...
def select_features_view(request):
    ...
    if request.method == 'POST':
        ...
        redirect_url = f'/select-candidates?languages_str={languages_str}&number_of_candidates={number_of_candidates}'
...
def select_candidates_view(request):
    ...
    number_of_candidates = int(number_of_candidates) if number_of_candidates else 10
